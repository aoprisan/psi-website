    ...
    <footer className="bg-[var(--neutral-800)] text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-white">Psychology Practice</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/about"
                  className="text-[var(--neutral-300)] hover:text-[var(--primary-light)] transition-colors"
                >
                  About
                </Link>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-[var(--neutral-700)]">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-[var(--neutral-400)] text-sm">
              © {currentYear} Psychology Practice. All rights reserved.
            </p>
